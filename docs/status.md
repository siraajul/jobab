...
Three of four are non-engineering. The engineering side is _done_ for pilot-start
purposes.
...
4. **This week** — do 5 real merchant interviews. Don't pitch — listen ([docs/ship/pilot/interview-script.md](./ship/pilot/interview-script.md)).
