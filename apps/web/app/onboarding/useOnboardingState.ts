...
import { SAMPLE_CSV, STEPS, splitCsvRow, type CsvFile, type StepKey } from './steps';

// Re-exported so the legacy `import { StepKey, STEPS } from './useOnboardingState'`
// surface keeps working.
export { STEPS, type StepKey, type CsvFile };
